...
class Cucian {
    ...
    // Menambahkan metode untuk ditimpa (override) oleh subclass
...
class pilihanCucian extends Cucian {
    ...
    // override tampilInfo dari kelas induk Cucian
    @Override
    public void tampilInfo() {
        System.out.println("=== INFORMASI LAYANAN CUCIAN ===");
        System.out.println("ID Layanan: " + id);
        System.out.println("Jenis Cucian: " + jenisCucian);
        System.out.println("Harga per Unit: Rp" + hargaCucian);
        System.out.println("Rekomendasi untuk: Semua jenis sepatu");
        System.out.println("============================");
    }
}
...
public class app {
    ...
    static void manajemenLayanan() {
        ...
        while (layananRunning) {
            ...
            System.out.println("5. Lihat Detail Jenis Cucian"); // Opsi baru untuk melihat detail jenis cucian
            ...
            switch (pilihan) {
                ...
                case 5 -> lihatDetailCucian(); // Menambahkan case untuk melihat detail jenis cucian
    ...
    // Metode baru untuk menampilkan detail jenis cucian menggunakan override
    static void lihatDetailCucian() {
        tampilkanCucian();
        ...
        if (pilihan >= 1 && pilihan <= daftarCucian.size()) {
            System.out.println("\n=== Detail Jenis Cucian ===");
            // Memanggil metode tampilInfo yang sudah di-override di kelas pilihanCucian
